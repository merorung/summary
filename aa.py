...
<div style="position: relative;">
    ...
    style="width: 100%; padding: 1rem 3rem 1rem 1rem; border: 2px solid #e2e8f0; 
    border-radius: 1rem; font-size: 1rem; background-color: white;">
    <div style="position: absolute; right: 1rem; top: 50%; transform: translateY(-50%); 
    color: #64748b; pointer-events: none;">➜</div>
</div>
""", unsafe_allow_html=True)

# JavaScript를 추가하여 입력값을 세션 스테이트로 전달
st.markdown("""
<script>
