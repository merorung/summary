...
mport bs4
rom langchain_community.document_loaders import WebBaseLoader
...
# 제목을 커스텀 HTML로 표시
t.markdown('<h1 class="main-title">웹 페이지 요약 애플리케이션</h1>', unsafe_allow_html=True)
# API 키 입력
PI_KEY = st.secrets["GEMINI_API_KEY"]
# URL 입력 받기
rl = st.text_input("URL을 입력하세요:", placeholder="https://example.com")
if url:
   try:
       # 로딩 상태 표시
